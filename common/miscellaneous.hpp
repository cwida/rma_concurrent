...
#ifndef COMMON_MISCELLANEOUS_HPP_
#define COMMON_MISCELLANEOUS_HPP_
...
/**
 * Set the name of the thread, it must a string up to 16 chars. The name is useful internal for debugging
 */
...
#endif /* COMMON_MISCELLANEOUS_HPP_ */
