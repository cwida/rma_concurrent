...
#ifndef COMMON_ERRORHANDLING_HPP_
#define COMMON_ERRORHANDLING_HPP_
 ...
 */
::std::ostream& operator<<(::std::ostream& out, ::common::Exception& e);
...
#define RAISE_EXCEPTION_CREATE_ARGUMENTS(msg) const char* file = __FILE__; int line = __LINE__; const char* function = __FUNCTION__; \
        auto& stream = ::common::Exception::utilitystream; \
 ...
 */
#define DEFINE_EXCEPTION( exceptionName ) class exceptionName: public ::common::Exception { \
        public: exceptionName(const std::string& exceptionClass, const std::string& message, const std::string& file, \
	        int line, const std::string& function) : \
	            ::common::Exception(exceptionClass, message, file, line, function) { } \
} /* End of DEFINE_EXCEPTION */

#endif /* COMMON_ERRORHANDLING_HPP_ */
