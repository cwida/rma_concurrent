 ...
 */
    ...
    struct Leaf { int64_t m_key; void* m_value; };
    ...
    public:
        ...
        static N *setLeaf(Leaf* tid);

        static N *getAnyChild(const N *n);

        static Leaf* getAnyChildTid(const N *n, bool &needRestart);
        ...
        static Leaf* getMaxLeaf(N* node, uint64_t node_version, bool& needRestart);
        ...
        static void dump(N* node, int level, int depth);
    };
