...
CachedDensityBounds::CachedDensityBounds(const DensityBounds& bounds) : m_density_bounds(bounds) { }
...
double CachedDensityBounds::get_lower_threshold_root() const noexcept {
    return m_density_bounds.rho_h;
}

double CachedDensityBounds::get_lower_threshold_leaves() const noexcept {
    return m_density_bounds.rho_0;
}
