...
#ifndef DATA_STRUCTURES_RMA_DENSITY_BOUNDS_HPP_
#define DATA_STRUCTURES_RMA_DENSITY_BOUNDS_HPP_
...
public:
    ...
    /**
     * Use the same density bounds of the given argument
     */
    CachedDensityBounds(const DensityBounds& bounds);
    ...
    /**
     * Retrieve the min density for the root of the calibrator tree, that is \rho_h
     */
    double get_lower_threshold_root() const noexcept;

    /**
     * Retrieve the min density for the leaves of the calibrator tree, that is \rho_0
     */
    double get_lower_threshold_leaves() const noexcept;
...
#endif /* DATA_STRUCTURES_RMA_DENSITY_BOUNDS_HPP_ */
