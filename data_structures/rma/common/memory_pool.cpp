...
CachedMemoryPool_ThreadUnsafe::CachedMemoryPool_ThreadUnsafe() : CachedMemoryPool_ThreadUnsafe(get_default_capacity()){ }

CachedMemoryPool_ThreadUnsafe::CachedMemoryPool_ThreadUnsafe(size_t capacity) : m_pool(capacity), m_counter(0) {  }
