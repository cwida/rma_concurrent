...
public:
    ...
    Gate* m_ptr_locks;
    rma::common::StaticIndex* m_ptr_index;
    ...
    // fire the task if m_wait_to_complete is empty ?
    bool m_rebalancing_window_computed;

    // Only used by the workers
    struct SubTask {
        int64_t m_position_start, m_position_end;
