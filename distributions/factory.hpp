...
#ifndef DISTRIBUTIONS_FACTORY_HPP_
#define DISTRIBUTIONS_FACTORY_HPP_
...
#define ADD_DISTRIBUTION(name, description, callable) distributions::factory().add(name, description, callable, __FILE__, __LINE__)
...
class Factory {
    ...
    public:
        ...
        virtual std::unique_ptr<Interface> make() = 0;
    };
...
public:
    ...
    std::unique_ptr<Interface> make(const std::string& name);
};

} // namespace distributions

#endif /* DISTRIBUTIONS_FACTORY_HPP_ */
